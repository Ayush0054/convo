...
function Navbar({ fetchAgain, setFetchAgain }: { fetchAgain: any; setFetchAgain: any;}) {
  ...
  return (
    <div className="bg-[#FD8D4E] hover:bg-[#fdae80]  max-h-xl grid justify-items-center md:flex md:justify-between  rounded-xl p-3 pb-5 pt-5 shadow-xl text-black uppercase">
      <div className=" flex items-center  pr-2  ">
        <img src={logo} alt="" className="hidden md:block max-w-2 max-h-14" />
        <h1 className=" text-4xl font-semibold">CONVO</h1>
      </div>
      <div className="  gap-10 items-center grid justify-items-center md:flex md:justify-between">
