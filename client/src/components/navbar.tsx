...
function Navbar({
  ...
  return (
    <div className="bg-[#FD8D4E]   max-h-xl grid justify-items-center md:flex md:justify-between  rounded-xl md:p-3 md:pb-5 md:pt-5 p-1 pb-3 pt-3 shadow-xl text-black uppercase">
      ...
      <div className=" gap-4 md:gap-10 items-center grid justify-items-center md:flex md:justify-between">
        ...
        <button onClick={lougout} className=" text-2xl text-white font-medium">
          Logout
        </button>
      </div>
    </div>
