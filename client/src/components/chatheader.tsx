...
function Chatheader({
  ...
  return (
    <div className=" text-white font-bold flex mt-5 mb-5 justify-between">
      <div className=" flex items-center gap-3">
        {/* <h1 className="hidden md:block text-5xl  ">Contacts</h1> */}
        <button
          onClick={handleClick}
          className="border border-gray-100 rounded-lg hover:shadow-md bg-[#FD8D4E] p-2 m-2 "
        >
          Add Contact
        </button>
        <button
          onClick={handleShowContact}
          className="  border border-gray-100 rounded-lg bg-[#FD8D4E] p-2 m-2 "
        >
